      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6 mb-8">
            ...
            <div>
              <span className="text-violet-500 text-sm font-medium uppercase tracking-widest">UI/UX Design</span>
              <h1 className="text-4xl md:text-6xl font-bold mt-2">Mobile App Design</h1>
            </div>
          </div>
          
          <p className="text-xl text-muted-foreground max-w-2xl">
            A wellness and meditation app designed to help users build healthy habits through gentle guidance, progress tracking, and personalized content recommendations.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-16">
        <div className="max-w-6xl mx-auto">
          <div className="aspect-video rounded-3xl bg-gradient-to-br from-violet-500/30 to-violet-500/5 flex items-center justify-center overflow-hidden relative">
            ...
            <Smartphone className="w-32 h-32 text-foreground/40" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Create a calming, intuitive mobile experience that encourages daily engagement without feeling pushy, while making complex wellness concepts accessible and actionable.
            </p>
          </div>
          <div>
            <h2 className="text-2xl font-bold mb-6">The Solution</h2>
            <p className="text-muted-foreground leading-relaxed">
              A serene visual language with soft gradients, gentle animations, and thoughtful micro-interactions that guide users through their wellness journey with empathy and encouragement.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-16">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-lg font-medium mt-2">5 Months</p>
          </div>
          <div>
            <span className="text-sm text-muted-foreground uppercase tracking-widest">Tools</span>
            <p className="text-lg font-medium mt-2">Figma, Principle</p>
          </div>
          <div>
