        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6 mb-8">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-bold mt-2">Brand Identity System</h1>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Develop a distinctive brand identity that captures the company's innovative spirit while remaining versatile enough for various applications across digital and print media.
            </p>
          </div>
          <div>
            <h2 className="text-2xl font-bold mb-6">The Solution</h2>
            <p className="text-muted-foreground leading-relaxed">
              A bold, geometric visual system with a flexible color palette and custom typography that scales beautifully from app icons to billboard advertisements.
            </p>
          </div>
        </div>
      </section>
